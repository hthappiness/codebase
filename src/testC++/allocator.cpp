...
int test_allocator_1()
{
	...
	//std::cout << *q << std::endl; // 灾难：q指向 "未构造的内存"
...
int test_allocator_2()
{
	...
	*/
    ...
    std::cout << p[1] << std::endl;
    std::cout << p[2] << std::endl;
    std::cout << p[vi.size()] << std::endl;
    std::cout << p[vi.size()+1] << std::endl;
    std::cout << p[vi.size()*2 - 1 ] << std::endl;
...
{
    std::cout<<"=========1===========\r\n";
    allocator_::test_allocator_1();
    std::cout<<"=========2===========\r\n";
    allocator_::test_allocator_2();
    std::cout<<"=========3===========\r\n";
    allocator_::test_allocator_3();
    std::cout<<"=========4===========\r\n";
    allocator_::test_allocator_4();
}